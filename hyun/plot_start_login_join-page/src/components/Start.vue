      ...
      <div class="start-page-warpper">
        <div class="start-page-center">
          ...
          <div class="start-button-warpper">
            <a class="start-login-facebook-link" href="">
              <span class="fa fa-facebook-official" aria-hidden="true"></span>
              <span class="facebook-login">페이스북 로그인</span></a>
            <a class="start-page-login-link" href="/login"><span class="login">로그인</span></a>
            <a class="start-join-link" href="/join"><span class="join">회원가입</span></a> 
          </div>
	    </div>
      </div>
    </div>
